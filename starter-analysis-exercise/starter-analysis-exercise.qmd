...
# dslabs has data
# ggplot2 is a thing for making plots
...
ggplot(divorce_margarine, aes(x = year)) + aes(y = divorce_rate_maine) + aes(y = margarine_consumption_per_capita) geom_point(
  mapping = aes(x = year, y = divorce_rate_maine) colour = 'green', size = 3
)
